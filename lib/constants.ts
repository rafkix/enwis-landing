...
export const FOOTER_LINKS = {
  company: [
    { label: "Biz Haqimizda", href: "/about" },
    { label: "B2B / Tashkilotlar", href: "/b2b" },
  ...
  legal: [
    ...
    { label: "Platforma Holati", href: "/status" },
  ],
} as const;

export const SOCIAL_LINKS = [
  { label: "Telegram", href: "https://t.me/enwis_uz" },
...
export const HERO_STATS = [
  ...
  { value: 1, suffix: "", label: "Ta'lim muassasalari" },
  { value: 1, suffix: "+", label: "Qamrab olingan talabalar" },
