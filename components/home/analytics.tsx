...
import { AnalyticsMockup } from "@/components/shared/mockups/dashboard-mockups";
        ...
        <div>
          ...
          <div className="mt-8 flex flex-col gap-6">
            {CALLOUTS.map((item, i) => (
              ...
              >
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[var(--color-volt)]/20">
                  <item.icon className="h-5 w-5 text-[var(--color-deep)]" />
                </div>
                <div>
