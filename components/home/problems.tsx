          ...
          {PROBLEMS.map((problem, i) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative overflow-hidden rounded-[var(--radius-xl)] border border-[var(--color-line)] bg-white p-6 transition-colors duration-300 hover:border-[var(--color-ink)]/15 ${
                  i % 2 === 1 ? "lg:mt-7" : ""
                }`}
              >
                ...
                <div className="relative">
                  <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-full bg-[var(--color-volt)]/20 transition-colors duration-300 group-hover:bg-[var(--color-volt)]">
                    <Icon
                      className="h-5 w-5 text-[var(--color-deep)] transition-colors duration-300 group-hover:text-[var(--color-deep-900)]"
                    />
                  </div>
